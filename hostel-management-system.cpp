        ...
        if (room < 0 || room > 10){
            ...
            if (created_node -> room_capacity >= people){
                ...
                while(created_node -> fill_room - 1 <= created_node -> room_capacity){
                    ...
                    cout << "Enter student ID  " << created_node-> fill_room + 1 << ": ";
...
int main(){
    ...
    management.create();
    do{
    	cout << "                                               Welcome to Hostel  Room allotment System"   << endl;
    	cout << "1. Facilities " <<  endl;
        cout << "2. Display Current Status of Rooms" << endl;
        cout << "3. Book a Room for 1 Student." << endl;
        cout << "4. Book a Room for 2 Students." << endl;
        cout << "5. Book a Room for 3 Students." << endl;
        cout << "6. Cancel an alloted Room" << endl;
        cout << "7. Search a student Name" << endl;
        cout << "8. rules and regulations"<< endl;
        cout << "Enter your choice: ";
        cin >> choice;
        switch (choice){
        	case 1:
        		cout << "Facilities  1.Clean and hygenic room " << endl;
           		cout << "            2.Internet facilities"<< endl;
				cout << "            3.emergency medical services"<< endl;
				cout << "            4.24*7 water and electricity"<< endl;
				cout << "            5.security"<< endl;
				cout << "            6.TV room and library"<< endl;
				break;
            ...
            case 8:
				...
				cout <<" 2.Loitering in the Hostel campus during the class hours will not be appreciated."<< endl;
				cout <<"3.Students must keep the Campus & Rooms clean. Defacing walls, equipment, furniture etc., is strictly prohibited."<< endl;
				cout <<"4.tudents are not allowed to use electric stoves, heaters etc in rooms except in designated places."<< endl;
				cout <<"5.Students during their stay in the hostel will be governed by the management rules."<< endl;
				cout <<"6.Food will be served only in the designated Dining Hall(s) and only during the specified timings. Wasting food & water will not be encouraged."<< endl;
				break;
